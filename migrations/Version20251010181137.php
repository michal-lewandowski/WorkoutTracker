 ...
 */
final class Version20251010181137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_exercise_sets_workout_exercise_id ON exercise_sets (workout_exercise_id)');
        $this->addSql('COMMENT ON COLUMN exercise_sets.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN exercise_sets.workout_exercise_id IS \'(DC2Type:ulid)\'');
        ...
        $this->addSql('CREATE INDEX idx_exercises_muscle_category_id ON exercises (muscle_category_id)');
        $this->addSql('CREATE UNIQUE INDEX idx_exercises_name ON exercises (name)');
        $this->addSql('COMMENT ON COLUMN exercises.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN exercises.muscle_category_id IS \'(DC2Type:ulid)\'');
        ...
        $this->addSql('COMMENT ON COLUMN muscle_categories.id IS \'(DC2Type:ulid)\'');
        ...
        $this->addSql('CREATE INDEX idx_workout_exercises_workout_session_id ON workout_exercises (workout_session_id)');
        $this->addSql('CREATE INDEX idx_workout_exercises_exercise_id ON workout_exercises (exercise_id)');
        $this->addSql('COMMENT ON COLUMN workout_exercises.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN workout_exercises.workout_session_id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN workout_exercises.exercise_id IS \'(DC2Type:ulid)\'');
        ...
        $this->addSql('CREATE INDEX idx_workout_sessions_user_id_date ON workout_sessions (user_id, date)');
        $this->addSql('CREATE INDEX idx_workout_sessions_deleted_by ON workout_sessions (deleted_by)');
        $this->addSql('CREATE INDEX idx_workout_sessions_active ON workout_sessions (user_id, date)');
        $this->addSql('COMMENT ON COLUMN workout_sessions.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN workout_sessions.user_id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN workout_sessions.deleted_by IS \'(DC2Type:ulid)\'');
